...
par(mfcol = c(2,2), mar=c(4,4,2,1)) # 2 rows, 2 columns.
...
points(feb_data$DateTime,feb_data$Sub_metering_2, type="l",col="red")
points(feb_data$DateTime,feb_data$Sub_metering_3, type="l",col="blue")
